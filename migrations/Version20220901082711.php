 ...
 */
final class Version20220901082711 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE article (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, uri VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL)');
        $this->addSql('CREATE TABLE produit (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, prix VARCHAR(255) NOT NULL, titre VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL)');
        $this->addSql('DROP TABLE product');
        $this->addSql('DROP TABLE test_unit');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, price INTEGER NOT NULL, description VARCHAR(255) NOT NULL COLLATE BINARY)');
        $this->addSql('CREATE TABLE test_unit (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL)');
